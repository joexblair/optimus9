...
# 2. trade_gate reconfig: rebuild as s6m -> xm45a -> gcs15a (drop old s3/xm45)
db.execute("DELETE FROM trade_gate_line"); db.execute("DELETE FROM trade_gate")
db.execute("INSERT INTO trade_gate (tg_pk,tg_seq,tg_name,tg_op,tg_active) VALUES (1,1,'s6m','AND',1),(2,2,'xm45a','AND',1),(3,3,'gcs15a','AND',1)")
gl=[(1,s6m),(2,51),(2,50),(2,52),(3,79),(3,80),(3,81)]   # s6m | xm45 M/m/r | gcs15 M/m/r
