...
- **OOB gate emulation tuning as PRECURSOR**: dial in bny30M/p gates
  ...
  validated gates.
  **→ DESIGNED 2026-05-31: `gate_sweep_design.md`.** "Regime separation"
  is now defined — the **gate match score** (breach windows vs price-
  intrinsic ±0.9% profit partition). Precursor confirmed: gate is the
  deepest root; dial it before any keeper per-line library. gcs5M grind
  (tc=108) parks ready until the gate's validated.
