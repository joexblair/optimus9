...
.grids{display:flex;gap:8px;margin-top:3px}.cg{border-collapse:collapse;table-layout:fixed;width:auto;min-width:0}
.cg td{width:22px;height:26px;font-family:var(--mono);font-size:11px;font-weight:600;line-height:1.05;text-align:center;vertical-align:middle;padding:1px 1px;border:1px solid var(--line);white-space:normal;overflow-wrap:anywhere;overflow:hidden;color:transparent}
