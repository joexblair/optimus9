...
.grids{display:flex;gap:8px;margin-top:3px}.cg{border-collapse:collapse;table-layout:fixed}
.cg td{width:22px;font-family:var(--mono);font-size:11px;font-weight:600;line-height:1.05;text-align:center;vertical-align:middle;padding:1px 2px;border:1px solid var(--line);white-space:normal;overflow-wrap:anywhere;color:transparent}
