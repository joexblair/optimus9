    ...
    def report(self, end_ms=None) -> list:
        ...
        for i in range(len(ts)):
            ...
            rows.append({
                ...
                'pk_anchor': _f(r['pk_anch'][i]),          # exit2 reversal anchor (K 1 bar pre-extreme)
...
'''
    ...
    def _persist(self, rows):
        ...
        cols = ['bar_time', 'px_smooth',
                ...
                'k_line', 'bb_main', 'bb_mid', 'k_gt_bb_main', 'slope_k', 'pk_anchor',
        ...
        data = [[_dt(r['bar_ms']), r['px_smooth'],
                 ...
                 r['hb9b'], r['hb9M'], r['hb9m'], r['k_gt_bb_main'], r['slope_k'], r['pk_anchor'],
